    ...
    <div className="py-16 flex justify-center">
      <div className=" md:h-[324px] bg-[#F5F5F5F5] dark:bg-[#313135] md:flex justify-between items-center rounded-xl">
        <div className="md:pl-10 p-2  md:text-left text-center">
          <h1 className="md:text-[40px] text-[24px] font-semibold pb-[34px] md:leading-[56.934px] leading-[34.161px]">
            Ready to begin your crypto mining <br /> journey?
          </h1>
          {/* button */}

          <Link to="/register">
            <div className="cursor-pointer mb-3 font-medium">
              <CustomButton width="160px" content="Get Started" />
            </div>
          </Link>
        </div>
        <div>
